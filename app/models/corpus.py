...
class Corpus(db.Model):
    ...
    def get_tokens(self):
        ...
        """
        # allowed = (
        #     getattr(WordToken, name)
        #     for name in self.displayed_columns_by_name
        #     if name != "similar"
        # )
        # return WordToken.query.filter_by(corpus=self.id).with_entities(
        #     WordToken.id,
        #     WordToken.corpus,
        #     WordToken.order_id,
        #     WordToken.form,
        #     WordToken.label_uniform,
        #     WordToken.left_context,
        #     WordToken.right_context,
        #     *allowed
        # ).order_by(WordToken.order_id)
